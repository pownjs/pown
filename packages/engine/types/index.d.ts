...
declare module 'lib/template' {
  ...
  export class Template {
     ...
     */
    getTestConditionFunc(
      condition: MatcherCondition
    ): (
      it: Iterable<any>,
      handler: import('./async.js').Handler
    ) => Promise<boolean>
    /**
     *
    ...
    runTaskSetIt(
      ...
      input: any,
      ...args: any[]
    ): AsyncGenerator<TaskResult, void, unknown>
    runTaskSet(
      taskName: any,
      tasks: any,
      input: any,
...
declare module 'lib/helper' {
  ...
  export type TaskDefinition = {
    [taskName: string]: {
      ...
      run?: (
        ...
        input: Input,
        ...args: any
      ) => void | TaskResult | Promise<void> | Promise<TaskResult>
      handle?: (
        task: Task,
        input: Input,
        ...args: any
   ...
   */
  export function createSuperTemplate(
