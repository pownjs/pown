...
const connectInternal = (connect, resolve) => {
    const { type = 'base', host, port, data, info, timeout = 30000, connectTimeout = timeout, dataTimeout = timeout, download = true, downloadLimit = Infinity, certificate = false, ssl: _ssl = false, tls: _tls = _ssl, client = _tls ? tls : net, ...options } = connect
